...
#ifndef __APM32E030_H
#define __APM32E030_H
...
/** @addtogroup APM32E030
  * @brief Peripheral Access Layer
  @{
*/
#if defined (APM32E030x6) || defined (APM32E030x8)
#define    APM32E030
#endif /*!< APM32E030x6 or APM32E030x8 or APM32E030xC */

#if !defined (APM32E030)
#error "Please select first the target APM32E030 device used in your application (in apm32e030.h file)"
#endif
...
/** @defgroup APM32E030_StdPeripheral_Library_Version
  @{
*/

/*!< [31:16] apm32e030 Standard Peripheral Library main version V1.0.0*/
#define __APM32E0_DEVICE_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __APM32E0_DEVICE_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __APM32E0_DEVICE_VERSION_SUB2   (0x02) /*!< [15:8]  sub2 version */
#define __APM32E0_DEVICE_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define __APM32E0_DEVICE_VERSION        ((__APM32E0_DEVICE_VERSION_MAIN << 24)\
                                        |(__APM32E0_DEVICE_VERSION_SUB1 << 16)\
                                        |(__APM32E0_DEVICE_VERSION_SUB2 << 8 )\
                                        |(__APM32E0_DEVICE_VERSION_RC))

/**@} end of group APM32E030_StdPeripheral_Library_Version */
...
/* APM32E030 do not provide MPU  */
#define __MPU_PRESENT             0
/* APM32E030 uses 2 Bits for the Priority Levels */
...
typedef enum
{
    ...
    /*  APM32E030 specific Interrupt Numbers */
...
#include "system_apm32e030.h" /*!< APM32E030 System Header */
#include <stdint.h>
