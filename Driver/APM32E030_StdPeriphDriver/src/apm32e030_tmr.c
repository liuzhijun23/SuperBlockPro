 ...
 *
 * @param     TMRx: x can be can be 1, 3, 6, 14, 15, 16 and 17 to select Timer
 *
 * @retval    None
 */
 ...
 *
 * @param      TMRx: x can be can be 1, 3 to select Timer
 *
 ...
 *
 * @param     TMRx: x can be can be 1, 3, 14, 15, 16 and 17 to select Timer
 *
 ...
 *
 * @param     TMRx: x can be can be 1, 3 and 15 to select Timer
 *
 * @param     OCcongigStruct: Channel configuration structure
 *
 * @retval    None
 ...
 * @retval    None
 *
 * @note      TMR2 it's not for APM32E030 devices
 */
 ...
 *
 * @param     TMRx: where x can be 1, 3, 14, 15, 16 and 17 to select the TMR peripheral
 *
 ...
 *
 * @param     TMRx: where x can be 1, 3 and 15 to select the TMR peripheral
 *
 * @param     OCFast: new state of the Output Compare Fast Enable Bit
 *                  This parameter can be one of the following values:
 *                     @arg TMR_OCFAST_DISABLE
 ...
 *
 * @param     TMRx: where x can be 1, 3 to select the TMR peripheral
 *
 * @param     OCFast: new state of the Output Compare Fast Enable Bit
 *                  This parameter can be one of the following values:
 *                     @arg TMR_OCFAST_DISABLE
 ...
 *
 * @param     TMRx: x can be  1, 3 to select Timer.
 *
 ...
 *
 * @param     TMRx: where x can be 1, 3, 14, 15, 16 and 17 to select the TMR periphera
 *
 * @param     ICpolarity: The Input Polarity.
 *
 * @param     ICselection: specifies the input to be used.
 ...
 *
 * @param     TMRx: where x can be 1, 3, 14, 15, 16 or 17 to select the TMR peripheral
 *
 * @param     ICpolarity: The Input Polarity.
 *
 * @param     ICselection: specifies the input to be used.
 ...
 *
 * @param     TMRx: where x can be 1, 3, 15, 16 and 17 to select the TMR peripheral
 *
 ...
 *
 * @param     TMRx: where x can be 1, 3, 6, 15, 16 and 17 to select the TMR peripheral
 *
 ...
 *
 * @param     TMRx: where x can be 1, 3, and 15 select the TMR peripheral
 *
 * @retval    None
 */
 ...
 *
 * @param     TMRx: where x can be 1, 3, 6 and 15 select the TMR peripheral
 *
