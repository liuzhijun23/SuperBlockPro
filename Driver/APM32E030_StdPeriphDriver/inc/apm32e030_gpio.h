...
#ifndef __APM32E030_GPIO_H
#define __APM32E030_GPIO_H
...
typedef struct
{
    ...
    GPIO_OUT_TYPE_T  outtype;  /*!< Specifies the operating output type for the selected pins */
