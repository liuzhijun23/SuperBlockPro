# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_ob.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_ob.h"
...
# 36 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_ob.h"
...
typedef struct
{
    OB_READ_PRO_T  readProtection;          
    OB_WDT_T       wdt;                     
    OB_STOP_T      stop;                    
    OB_STANDBY_T   stdby;                   
    OB_BOOT1_T     boot;                    
    OB_VDDA_T      vdda;                    
    OB_RAM_PARITY_CHECK_T  ramParityCheck;  
} OB_UserConfig_T;
...
# 27 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_ob.c"
...
void OB_ReadProtectionOptionByte(OB_READ_PRO_T readProtection)
{
    ((OB_T*) ((uint32_t)0x1FFFF800))->READPORT_B.READPROT = readProtection;
}
...
void OB_OptionBytesWatchdog(OB_WDT_T wdt)
{
    ((OB_T*) ((uint32_t)0x1FFFF800))->USER_B.WDTSEL = wdt;
}
...
void OB_OptionBytesStop(OB_STOP_T stop)
{
    ((OB_T*) ((uint32_t)0x1FFFF800))->USER_B.RSTSTOP = stop;
}
...
void OB_OptionBytesStandby(OB_STANDBY_T standby)
{
    ((OB_T*) ((uint32_t)0x1FFFF800))->USER_B.RSTSTDBY = standby;
}
...
void OB_OptionBytesBoot1(OB_BOOT1_T boot)
{
    ((OB_T*) ((uint32_t)0x1FFFF800))->USER_B.BOT1 = boot;
}
...
void OB_OptionBytesVddaAnalog(OB_VDDA_T vdda)
{
    ((OB_T*) ((uint32_t)0x1FFFF800))->USER_B.VDDAMON = vdda;
}
...
void OB_OptionBytesRamParity(OB_RAM_PARITY_CHECK_T ramParityCheck)
{
    ((OB_T*) ((uint32_t)0x1FFFF800))->USER_B.RPC = ramParityCheck;
}
