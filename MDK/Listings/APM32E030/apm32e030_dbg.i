# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_dbg.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_dbg.h"
...
# 36 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_dbg.h"
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_dbg.c"
...
uint32_t DBG_ReadDevId(void)
{
    return ((uint32_t)((DBG_T*) (((uint32_t)0x40000000) + 0x00015800))->IDCODE_B.EQR);
}
...
uint32_t DBG_ReadRevId(void)
{
    return ((uint32_t)((DBG_T*) (((uint32_t)0x40000000) + 0x00015800))->IDCODE_B.WVR);
}
...
void DBG_EnableDebugMode(uint32_t mode)
{
    ((DBG_T*) (((uint32_t)0x40000000) + 0x00015800))->CFG |= (uint32_t)mode;
}
...
void DBG_EnableAPB1Periph(uint32_t peripheral)
{
    ((DBG_T*) (((uint32_t)0x40000000) + 0x00015800))->APB1F |= (uint32_t)peripheral;
}
...
void DBG_EnableAPB2Periph(uint32_t peripheral)
{
    ((DBG_T*) (((uint32_t)0x40000000) + 0x00015800))->APB2F |= (uint32_t)peripheral;
}
