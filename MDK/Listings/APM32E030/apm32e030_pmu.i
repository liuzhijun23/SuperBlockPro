# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_pmu.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_pmu.h"
...
# 34 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_pmu.h"
...
# 27 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_pmu.c"
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_pmu.c"
...
void PMU_EnableBackupAccess(void)
{
    ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CTRL_B.BPWEN = BIT_SET;
}
...
void PMU_DisableBackupAccess(void)
{
    ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CTRL_B.BPWEN = BIT_RESET;
}
...
void PMU_EnableWakeUpPin(PMU_WAKEUPPIN_T pin)
{
    ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CSTS |= pin;
}
...
void PMU_EnterSTOPMode(PMU_REGULATOR_T regulator, PMU_STOPENTRY_T entry)
{
    ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CTRL_B.PDDSCFG = BIT_RESET;

    ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CTRL_B.LPDSCFG = regulator;
...
void PMU_EnterSTANDBYMode(void)
{
    ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CTRL_B.PDDSCFG = BIT_SET;
...
uint8_t PMU_ReadStatusFlag(PMU_FLAG_T flag)
{
    ...
    if ((((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CSTS & flag) != (uint32_t)RESET)
    {
        bit = SET;
    }
    else
...
void PMU_ClearStatusFlag(uint8_t flag)
{
    ...
    {
        ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CTRL_B.WUFLGCLR = BIT_SET;
    }
    else if (flag == PMU_FLAG_STDBYF)
    {
        ((PMU_T*) (((uint32_t)0x40000000) + 0x00007000))->CTRL_B.SBFLGCLR = BIT_SET;
    }
}
