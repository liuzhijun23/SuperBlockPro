# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_rtc.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_rtc.h"
...
# 34 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_rtc.h"
...
typedef enum
{
    RTC_FLAG_AWF        = 0x00000001,   
    RTC_FLAG_SOPF       = 0x00000008,   
    RTC_FLAG_ISF        = 0x00000010,   
    RTC_FLAG_RSF        = 0x00000020,   
    RTC_FLAG_INTF       = 0x00000040,   
    RTC_FLAG_ALRF       = 0x00000100,   
    RTC_FLAG_TSF        = 0x00000800,  
    RTC_FLAG_TSOF       = 0x00001000,  
    RTC_FLAG_TP1F       = 0x00002000,  
    RTC_FLAG_TP2F       = 0x00004000,  
    RTC_FLAG_RPF        = 0x00010000,  
} RTC_FLAG_T;
...
# 330 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_rtc.h"

# 338 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_rtc.h"
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_rtc.c"
...
# 29 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_rtc.c"
...
uint8_t RTC_Reset(void)
{
    ...
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TIME     = (uint32_t)0x00000000;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->DATE     = (uint32_t)0x00002101;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL    &= (uint32_t)0x00000000;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->PSC      = (uint32_t)0x007F00FF;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA    = (uint32_t)0x00000000;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->SHIFT    = (uint32_t)0x00000000;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CAL      = (uint32_t)0x00000000;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMASS  = (uint32_t)0x00000000;

        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS = (uint32_t)0x00000007;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG = 0x00000000;
...
uint8_t RTC_Config(RTC_Config_T* Struct)
{
    ...
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.TIMEFCFG  = (Struct->format);
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->PSC_B.SPSC = (Struct->SynchPrediv);
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->PSC_B.APSC = (Struct->AsynchPrediv);
...
void RTC_EnableWriteProtection(void)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->WRPROT = 0xFF;
}
...
void RTC_DisableWriteProtection(void)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->WRPROT = 0xCA;
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->WRPROT = 0x53;
}
...
uint8_t RTC_EnableInit(void)
{
    ...
    if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.RINITFLG == BIT_RESET)
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS = (uint32_t)0xFFFFFFFF;

        do
        {
            initstatus = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.RINITFLG;
            cnt++;
        }
        while ((cnt != ((uint32_t) 0x00004000)) && (initstatus == 0x00));
...
void RTC_DisableInit(void)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.INITEN = BIT_RESET;
}
...
uint8_t RTC_WaitForSynchro(void)
{
    ...
    if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.RCMCFG == BIT_RESET)
    {
        return SUCCESS;
    }
    else
    {
        RTC_DisableWriteProtection();
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS &= (uint32_t)0xFFFFFF5F;

        do
        {
            synchrostatus = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.RSFLG;
            cnt++;
        }
        while ((cnt != ((uint32_t) 0x00008000)) && (synchrostatus == 0x00));

        if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.RSFLG != BIT_RESET)
        {
            RTC_EnableWriteProtection();
            return SUCCESS;
        }
...
uint8_t RTC_EnableRefClock(void)
{
    ...
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.RCLKDEN = BIT_SET;
        RTC_DisableInit();
        RTC_EnableWriteProtection();
        return SUCCESS;
    }
...
uint8_t RTC_DisableRefClock(void)
{
    ...
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.RCLKDEN = BIT_RESET;
        RTC_DisableInit();
        RTC_EnableWriteProtection();
        return SUCCESS;
    }
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.RCMCFG = BIT_SET;
    RTC_EnableWriteProtection();
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.RCMCFG = BIT_RESET;
    RTC_EnableWriteProtection();
}
...
uint8_t RTC_ConfigTime(RTC_FORMAT_T format, RTC_TIME_T* timeStruct)
{
    ...
    {
        if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.TIMEFCFG == BIT_RESET)
        {
    ...
    if (format != RTC_FORMAT_BIN)
    {
        temp = (((uint32_t)(timeStruct->hours) << 16) |                 ((uint32_t)(timeStruct->minutes) << 8) |                 ((uint32_t)(timeStruct->seconds)) |                 ((uint32_t)(timeStruct->H12) << 22));
    ...
    {
        temp = (((uint32_t)RTC_ByteConBcd2(timeStruct->hours) << 16) |                 ((uint32_t)RTC_ByteConBcd2(timeStruct->minutes) << 8) |                 ((uint32_t)RTC_ByteConBcd2(timeStruct->seconds)) |                 ((uint32_t)(timeStruct->H12) << 22));
    ...
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TIME = (uint32_t)(temp & 0x007F7F7F);
        RTC_DisableInit();

        if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.RCMCFG == RESET)
        {
            if (RTC_WaitForSynchro() == ERROR)
            {
                state = ERROR;
...
{
    uint32_t temp = 0;
    temp = (uint32_t)((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TIME) & 0x007F7F7F);
...
{
    uint32_t temp = 0;
    temp = (uint32_t)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->SUBSEC);
    (void)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->DATE);
    return (temp);
}
...
uint8_t RTC_ConfigDate(RTC_FORMAT_T format, RTC_DATE_T* dateStruct)
{
    ...
    if (format != RTC_FORMAT_BIN)
    {
        temp = (((uint32_t)(dateStruct->year) << 16) |                 ((uint32_t)(dateStruct->month) << 8) |                 ((uint32_t)(dateStruct->date)) |                 ((uint32_t)(dateStruct->weekday) << 13));
    ...
    {
        temp = (((uint32_t)RTC_ByteConBcd2(dateStruct->year) << 16) |                 ((uint32_t)RTC_ByteConBcd2(dateStruct->month) << 8) |                 ((uint32_t)RTC_ByteConBcd2(dateStruct->date)) |                 ((uint32_t)(dateStruct->weekday) << 13));
    ...
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->DATE = (uint32_t)(temp & 0x00FFFF3F);
        RTC_DisableInit();
...
void RTC_ConfigDateStructInit(RTC_DATE_T* dateStruct)
{
    dateStruct->weekday = ((uint8_t)0x01);
    dateStruct->month = ((uint8_t)0x01);
    dateStruct->date = 1;
    dateStruct->year = 0;
}
...
{
    uint32_t temp = 0;
    temp = (uint32_t)((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->DATE) & 0x00FFFF3F);
...
void RTC_ConfigAlarm(RTC_FORMAT_T format, RTC_ALARM_T* alarmStruct)
{
    ...
    if (format == RTC_FORMAT_BCD)
    {
        temp = (((uint32_t)(alarmStruct->time.hours) << 16) |                 ((uint32_t)(alarmStruct->time.minutes) << 8) |                 ((uint32_t)alarmStruct->time.seconds) |                 ((uint32_t)(alarmStruct->time.H12) << 22) |                 ((uint32_t)(alarmStruct->AlarmDateWeekDay) << 24) |                 ((uint32_t)alarmStruct->AlarmDateWeekDaySel << 30) |                 ((uint32_t)alarmStruct->AlarmMask));
# 668 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_rtc.c"
    }
    else
    {
        temp = (((uint32_t)RTC_ByteConBcd2(alarmStruct->time.hours) << 16) |                 ((uint32_t)RTC_ByteConBcd2(alarmStruct->time.minutes) << 8) |                 ((uint32_t)RTC_ByteConBcd2(alarmStruct->time.seconds)) |                 ((uint32_t)(alarmStruct->time.H12) << 22) |                 ((uint32_t)RTC_ByteConBcd2(alarmStruct->AlarmDateWeekDay) << 24) |                 ((uint32_t)alarmStruct->AlarmDateWeekDaySel << 30) |                 ((uint32_t)alarmStruct->AlarmMask));
# 678 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_rtc.c"
    }

    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA = temp;
    RTC_EnableWriteProtection();
}
...
void RTC_ReadAlarm(RTC_FORMAT_T format, RTC_ALARM_T* alarmStruct)
{
    ...
    day_d = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.DAYT << 0x04;
    day_u = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.DAYU;
    hours_d = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.HRT << 0x04;
    hours_u = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.HRU;
    minutes_d = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.MINT << 0x04;
    minutes_u = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.MINU;
    seconds_d = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.SECT << 0x04;
    seconds_u = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.SECU;

    day_mask = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.DATEMEN << 8;
    hours_mask = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.HRMEN << 8;
    minutes_mask = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.MINMEN << 8;
    seconds_mask = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.SECMEN << 7;
    ...
    alarmStruct->time.H12     = (uint8_t)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.TIMEFCFG);
    alarmStruct->AlarmDateWeekDay = (uint8_t)(day_d | day_u);
    alarmStruct->AlarmDateWeekDaySel = (RTC_WEEKDAY_SEL_T)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMA_B.WEEKSEL);
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.ALREN = BIT_SET;
    RTC_EnableWriteProtection();
}
...
uint8_t RTC_DisableAlarm(void)
{
    ...
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.ALREN = BIT_RESET;

    while ((count != ((uint32_t) 0x00004000)) && ((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.ALRWFLG) == BIT_RESET))
    {
        count++;
    }

    if ((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.ALRWFLG) == BIT_RESET)
    {
        RTC_EnableWriteProtection();
        return ERROR;
    }
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMASS_B.SUBSEC = val;
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMASS_B.MASKSEL = mask;
    RTC_EnableWriteProtection();
}
...
uint32_t RTC_ReadAlarmSubSecond(void)
{
    return (uint32_t)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->ALRMASS_B.SUBSEC);
}
...
void RTC_ConfigDayLightSaving(RTC_DAYLIGHT_SAVING_T sav, RTC_STORE_OPERATION_T bit)
{
    ...
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.STCCFG = (uint32_t)BIT_SET;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.WTCCFG = (uint32_t)BIT_RESET;
    }
    else
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.STCCFG = (uint32_t)BIT_RESET;
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.WTCCFG = (uint32_t)BIT_SET;
    }

    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.BAKP = (uint32_t)bit;
    RTC_EnableWriteProtection();
}
...
uint32_t RTC_ReadStoreOperation(void)
{
    return (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.BAKP);
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.OUTSEL = (uint32_t)opsel;
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.POLCFG = (uint32_t)opp;
    RTC_EnableWriteProtection();
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.CALOEN = BIT_SET;
    RTC_EnableWriteProtection();
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.CALOEN = BIT_RESET;
    RTC_EnableWriteProtection();
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.CALOSEL = (uint32_t)calib;
    RTC_EnableWriteProtection();
}
...
uint8_t RTC_ConfigSmoothCalib(RTC_SCP_T period, RTC_SCPP_T bit, uint32_t value)
{
    ...
    if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.RCALPFLG != BIT_RESET)
    {
        while ((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.RCALPFLG != BIT_RESET) && (count != ((uint32_t) 0x00001000)))
        {
            count++;
        }
    }
    ...
    if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.RCALPFLG == BIT_RESET)
    {
        ...
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CAL = ((((uint32_t)bit << 15) |                          (uint32_t)BIT_SET << 13) |                         (uint32_t)value);


        }
        else
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CAL = ((((uint32_t)bit << 15) |                          (uint32_t)BIT_SET << 14) |                         (uint32_t)value);
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.TSEN = BIT_SET;
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.TSETECFG = (uint32_t)edge;
    RTC_EnableWriteProtection();
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.TSEN = BIT_RESET;
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.TSETECFG = (uint32_t)edge;
    RTC_EnableWriteProtection();
}
...
void RTC_ReadTimeDate(RTC_FORMAT_T format, RTC_TIME_T* timeStruct, RTC_DATE_T* dateStruct)
{
    ...
    temptime = (uint32_t)((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TSTIME) & 0x007F7F7F);
    tempdate = (uint32_t)((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TSDATE) & 0x00FFFF3F);
...
uint32_t RTC_ReadTimeStampSubSecond(void)
{
    return (uint32_t)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TSSUBSEC);
}
...
void RTC_ConfigTamperTrigger(RTC_TAMPER_T tamper, RTC_TAMPER_TRIGGER_T trigger)
{
    if (trigger == RTC_TAMPER_TRIGGER_RISINGEDGE)
    {
        ...
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP1ALCFG = BIT_RESET;
        }
        if (tamper == RTC_TAMPER_2)
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP2ALCFG = BIT_RESET;
        }
    }
    else
    {
        if (tamper == RTC_TAMPER_1)
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP1ALCFG = BIT_SET;
        }
        if (tamper == RTC_TAMPER_2)
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP2ALCFG = BIT_SET;
        }
    }
}
...
void RTC_EnableTamper(RTC_TAMPER_T tamper)
{
    if (tamper == RTC_TAMPER_1)
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP1EN = BIT_SET;
    }
    if (tamper == RTC_TAMPER_2)
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP2EN = BIT_SET;
    }
...
void RTC_DisableTamper(RTC_TAMPER_T tamper)
{
    if (tamper == RTC_TAMPER_1)
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP1EN = BIT_RESET;
    }
    if (tamper == RTC_TAMPER_2)
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP2EN = BIT_RESET;
    }
}
...
void RTC_ConfigFilter(RTC_TAMPER_FILTER_T filter)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPFCSEL = (uint32_t)filter;
}
...
void RTC_ConfigSamplingFreq(RTC_TAMPER_SAMPLING_FREQ_T freq)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPSFSEL = (uint32_t)freq;
}
...
void RTC_PinsPrechargeDuration(RTC_PRECHARGE_DURATION_T duration)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPPRDUSEL = (uint32_t)duration;
}
...
void RTC_EnableTDE(void)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPTSEN = BIT_SET;
}
...
void RTC_DisableTDE(void)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPTSEN = BIT_RESET;
}
...
void RTC_EnablePullUp(void)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPPUDIS = BIT_SET;
}
...
void RTC_DisablePullUp(void)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPPUDIS = BIT_RESET;
}
...
void RTC_WriteBackup(RTC_BAKP_DATA_T backup, uint32_t data)
{
    ...
    {
        case 0:
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP0 = data;
            break;

        case 1:
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP1 = data;
            break;

        case 2:
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP2 = data;
            break;

        case 3:
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP3 = data;
            break;

        case 4:
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP4 = data;
            break;
...
uint32_t RTC_ReadBackup(RTC_BAKP_DATA_T backup)
{
    ...
    {
        case 0:
            data = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP0;
            break;

        case 1:
            data = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP1;
            break;

        case 2:
            data = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP2;
            break;

        case 3:
            data = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP3;
            break;

        case 4:
            data = ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->BAKP4;
            break;
...
void RTC_ConfigOutputType(RTC_OUTPUT_T output)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.PC13VAL = (uint32_t)output;
}
...
uint8_t RTC_ConfigSynchroShift(RTC_SHIFT_ADD1S_T add1S, uint32_t subFS)
{
    ...
    if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.SOPFLG != BIT_RESET)
    {
        while ((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.SOPFLG != BIT_RESET) && (shpfcount != ((uint32_t) 0x00001000)))
        {
            shpfcount++;
        }
    }
    ...
    if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.SOPFLG == BIT_RESET)
    {
        if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.RCLKDEN == BIT_RESET)
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->SHIFT = (uint32_t)((uint32_t)(add1S << 31) | (uint32_t)subFS);
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL |= (uint32_t)(interrupt & ~0x00000004);
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG |= (uint32_t)(interrupt & 0x00000004);
    RTC_EnableWriteProtection();
}
...
uint8_t RTC_ReadIntFlag(RTC_INT_FLAG_T flag)
{
    ...
    if (flag & 0x04)
    {
        intEnable = (uint32_t)((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TPIEN;
        intStatus = (uint32_t)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS & (flag >> 4));
    }
    else
    {
        intEnable = (uint32_t)((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL;
        intStatus = (uint32_t)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS & (flag >> 4));
    }
...
void RTC_ClearIntFlag(uint32_t flag)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS &= (uint32_t) ~(flag >> 4);
}
...
uint8_t RTC_ReadStatusFlag(RTC_FLAG_T flag)
{
    return (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS & flag) ? SET : RESET;
}
...
void RTC_ClearStatusFlag(uint32_t flag)
{
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS &= (uint32_t)~flag;
}
