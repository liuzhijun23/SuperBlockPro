# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_spi.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_spi.h"
...
# 34 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_spi.h"
...
typedef enum
{
    SPI_MODE_SLAVE      = ((uint8_t)0),      
    SPI_MODE_MASTER     = ((uint8_t)1),      
} SPI_MODE_T;
...
typedef enum
{
    SPI_DATA_LENGTH_4B    = ((uint8_t)0x03),    
    SPI_DATA_LENGTH_5B    = ((uint8_t)0x04),    
    SPI_DATA_LENGTH_6B    = ((uint8_t)0x05),    
    SPI_DATA_LENGTH_7B    = ((uint8_t)0x06),    
    SPI_DATA_LENGTH_8B    = ((uint8_t)0x07),    
    SPI_DATA_LENGTH_9B    = ((uint8_t)0x08),    
    SPI_DATA_LENGTH_10B   = ((uint8_t)0x09),    
    SPI_DATA_LENGTH_11B   = ((uint8_t)0x0A),    
    SPI_DATA_LENGTH_12B   = ((uint8_t)0x0B),    
    SPI_DATA_LENGTH_13B   = ((uint8_t)0x0C),    
    SPI_DATA_LENGTH_14B   = ((uint8_t)0x0D),    
    SPI_DATA_LENGTH_15B   = ((uint8_t)0x0E),    
    SPI_DATA_LENGTH_16B   = ((uint8_t)0x0F),    
} SPI_DATA_LENGTH_T;
...
typedef enum
{
    SPI_CRC_LENGTH_8B       = ((uint8_t)0),  
    SPI_CRC_LENGTH_16B      = ((uint8_t)1),  
} SPI_CRC_LENGTH_T;
...
typedef enum
{
    SPI_SSC_DISABLE         = ((uint8_t)0), 
    SPI_SSC_ENABLE          = ((uint8_t)1), 
} SPI_SSC_T;
...
typedef enum
{
    SPI_RXFIFO_HALF         = ((uint8_t)0), 
    SPI_RXFIFO_QUARTER      = ((uint8_t)1), 
} SPI_RXFIFO_T;
...
typedef enum
{
    SPI_LAST_DMA_TXRXEVEN    = ((uint16_t)0x0000),  
    SPI_LAST_DMA_TXEVENRXODD = ((uint16_t)0x2000),  
    SPI_LAST_DMA_TXODDRXEVEN = ((uint16_t)0x4000),  
    SPI_LAST_DMA_TXRXODD     = ((uint16_t)0x6000),  
} SPI_LAST_DMA_T;
...
typedef enum
{
    SPI_TXFIFO_LEVEL_EMPTY   = ((uint8_t)0x00),     
    SPI_TXFIFO_LEVEL_QUARTER = ((uint8_t)0x01),     
    SPI_TXFIFO_LEVEL_HALF    = ((uint8_t)0x02),     
    SPI_TXFIFO_LEVEL_FULL    = ((uint8_t)0x03),     
} SPI_TXFIFO_LEVEL_T;
...
typedef enum
{
    SPI_RXFIFO_LEVEL_EMPTY    = ((uint8_t)0x00),    
    SPI_RXFIFO_LEVEL_QUARTER  = ((uint8_t)0x01),    
    SPI_RXFIFO_LEVEL_HALF     = ((uint8_t)0x02),    
    SPI_RXFIFO_LEVEL_FULL     = ((uint8_t)0x03),    
} SPI_RXFIFO_LEVEL_T;
...
typedef enum
{
    SPI_FLAG_RXBNE      = ((uint16_t)0x0001),       
    SPI_FLAG_TXBE       = ((uint16_t)0x0002),       
    I2S_FLAG_CHDIR      = ((uint16_t)0x0004),       
    I2S_FLAG_UDR        = ((uint16_t)0x0008),       
    SPI_FLAG_CRCE       = ((uint16_t)0x0010),       
    SPI_FLAG_MME        = ((uint16_t)0x0020),       
    SPI_FLAG_OVR        = ((uint16_t)0x0040),       
    SPI_FLAG_BUSY       = ((uint16_t)0x0080),       
    SPI_FLAG_FFE        = ((uint16_t)0x0100),       
} SPI_FLAG_T;
...
typedef enum
{
    SPI_INT_ERRIE       = ((uint8_t)0x20),          
    SPI_INT_RXBNEIE     = ((uint8_t)0x40),          
    SPI_INT_TXBEIE      = ((uint8_t)0x80),          
} SPI_INT_T;
...
typedef enum
{
    SPI_INT_FLAG_RXBNE      = ((uint32_t)0x400001), 
    SPI_INT_FLAG_TXBE       = ((uint32_t)0x800002), 
    SPI_INT_FLAG_UDR        = ((uint32_t)0x200008), 
    SPI_INT_FLAG_MME        = ((uint32_t)0x200020), 
    SPI_INT_FLAG_OVR        = ((uint32_t)0x200040), 
    SPI_INT_FLAG_FFE        = ((uint32_t)0x200100), 
} SPI_INT_FLAG_T;
...
typedef struct
{
    ...
    SPI_SSC_T            slaveSelect;    
    SPI_FIRST_BIT_T      firstBit;       
...
# 27 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_spi.c"
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_spi.c"
...
void SPI_Reset(SPI_T* spi)
{
    if (spi == ((SPI_T*) (((uint32_t)0x40000000) + 0x00013000)))
    {
