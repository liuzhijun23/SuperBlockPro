...
# 31 "..\\Src\\apm32e030_int.c"
# 32 "..\\Src\\apm32e030_int.c"
# 33 "..\\Src\\apm32e030_int.c"
...
{
    if (TMR_ReadIntFlag(((TMR_T*) (((uint32_t)0x40000000) + 0x00001000)), TMR_INT_FLAG_UPDATE) == SET)
    {
         
        TMR_ClearIntFlag(((TMR_T*) (((uint32_t)0x40000000) + 0x00001000)), TMR_INT_FLAG_UPDATE);
...
{
    if (TMR_ReadIntFlag(((TMR_T*) (((uint32_t)0x40000000) + 0x00014800)), TMR_INT_FLAG_UPDATE) == SET)
    {
         
        TMR_ClearIntFlag(((TMR_T*) (((uint32_t)0x40000000) + 0x00014800)), TMR_INT_FLAG_UPDATE);

        if (!playing) return;
    
        if (adpcm_byte_pos >= 2816) {
        ...
        int32_t amplified = (int32_t)sample * 200 / 100;
