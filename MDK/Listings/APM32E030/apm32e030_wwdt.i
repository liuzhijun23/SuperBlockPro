# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_wwdt.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_wwdt.h"
...
# 34 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_wwdt.h"
...
# 27 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_wwdt.c"
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_wwdt.c"
...
void WWDT_SetTimebase(uint32_t div)
{
    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->CFG_B.TBPSC = 0;
    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->CFG_B.TBPSC = div;
}
...
void WWDT_ConfigWindowValue(uint16_t windowValue)
{
    ...
    reg = (windowValue | 0x00000040) & 0x7f;

    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->CFG_B.WIN = reg;
}
...
void WWDT_EnableEWI(void)
{
    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->CFG_B.EWIEN = SET;
}
...
void WWDT_ConfigCounter(uint8_t couter)
{
    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->CTRL = (uint32_t)(couter & 0x7f);
}
...
void WWDT_Enable(uint8_t count)
{
    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->CTRL_B.CNT = count;
    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->CTRL_B.WWDTEN = SET;
}
...
uint8_t WWDT_ReadStatusFlag(void)
{
    return (uint8_t)(((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->STS);
}
...
void WWDT_ClearStatusFlag(void)
{
    ((WWDT_T*) (((uint32_t)0x40000000) + 0x00002C00))->STS_B.EWIFLG = RESET;
}
