# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_syscfg.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_syscfg.h"
...
# 34 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_syscfg.h"
...
typedef enum
{
    SYSCFG_PORT_GPIOA   = ((uint8_t)0x00),    
    SYSCFG_PORT_GPIOB   = ((uint8_t)0x01),    
    SYSCFG_PORT_GPIOC   = ((uint8_t)0x02),    
    SYSCFG_PORT_GPIOD   = ((uint8_t)0x03),    
    SYSCFG_PORT_GPIOF   = ((uint8_t)0x05),    
} SYSCFG_PORT_T;
...
typedef enum
{
    SYSCFG_PIN_0    = ((uint8_t)0x00),        
    SYSCFG_PIN_1    = ((uint8_t)0x01),        
    SYSCFG_PIN_2    = ((uint8_t)0x02),        
    SYSCFG_PIN_3    = ((uint8_t)0x03),        
    SYSCFG_PIN_4    = ((uint8_t)0x04),        
    SYSCFG_PIN_5    = ((uint8_t)0x05),        
    SYSCFG_PIN_6    = ((uint8_t)0x06),        
    SYSCFG_PIN_7    = ((uint8_t)0x07),        
    SYSCFG_PIN_8    = ((uint8_t)0x08),        
    SYSCFG_PIN_9    = ((uint8_t)0x09),        
    SYSCFG_PIN_10   = ((uint8_t)0x0A),        
    SYSCFG_PIN_11   = ((uint8_t)0x0B),        
    SYSCFG_PIN_12   = ((uint8_t)0x0C),        
    SYSCFG_PIN_13   = ((uint8_t)0x0D),        
    SYSCFG_PIN_14   = ((uint8_t)0x0E),        
    SYSCFG_PIN_15   = ((uint8_t)0x0F),        
} SYSCFG_PIN_T;
...
typedef enum
{
    SYSCFG_MEMORY_REMAP_FMC     = ((uint8_t)0x00),          
    SYSCFG_MEMORY_REMAP_SYSTEM  = ((uint8_t)0x01),          
    SYSCFG_MEMORY_REMAP_SRAM    = ((uint8_t)0x03),          
...
typedef enum
{
    SYSCFG_DAM_REMAP_ADC       = ((uint32_t)0x00000100),    
    SYSCFG_DAM_REMAP_USART1TX  = ((uint32_t)0x00000200),    
    SYSCFG_DAM_REMAP_USART1RX  = ((uint32_t)0x00000400),    
    SYSCFG_DAM_REMAP_TMR16     = ((uint32_t)0x00000800),    
    SYSCFG_DAM_REMAP_TMR17     = ((uint32_t)0x00001000),    
} SYSCFG_DAM_REMAP_T;
...
typedef enum
{
    SYSCFG_I2C_FMP_PB6       = ((uint32_t)0x00010000),      
    SYSCFG_I2C_FMP_PB7       = ((uint32_t)0x00020000),      
    SYSCFG_I2C_FMP_PB8       = ((uint32_t)0x00040000),      
    SYSCFG_I2C_FMP_PB9       = ((uint32_t)0x00080000),      
    SYSCFG_I2C_FMP_I2C1      = ((uint32_t)0x00100000),      
    SYSCFG_I2C_FMP_PA9       = ((uint32_t)0x00400000),      
    SYSCFG_I2C_FMP_PA10      = ((uint32_t)0x00800000),      
} SYSCFG_I2C_FMP_T;
...
typedef enum
{
    SYSCFG_LOCK_LOCKUP     = ((uint32_t)0x00000001),        
    SYSCFG_LOCK_SRAM       = ((uint32_t)0x00000002),        
} SYSCFG_LOCK_T;
...
typedef enum
{
    SYSCFG_CFG2_SRAMPEF     = ((uint32_t)0x00000100),       
} SYSCFG_FLAG_T;
...
# 27 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_syscfg.c"
...
void SYSCFG_Reset(void)
{
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG1 &= (uint32_t) ((uint32_t)0x00000003);;
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG1 = 0;
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG2 = 0;
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG3 = 0;
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG4 = 0;
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2 |= (uint32_t) SYSCFG_CFG2_SRAMPEF;
}
...
void SYSCFG_MemoryRemapSelect(uint8_t memory)
{
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG1_B.MMSEL = (uint8_t)memory;
}
...
void SYSCFG_EnableDMAChannelRemap(uint32_t channel)
{
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG1 |= (uint32_t)channel;
}
...
void SYSCFG_EnableI2CFastModePlus(uint32_t pin)
{
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG1 |= (uint32_t)pin;
}
...
void SYSCFG_EINTLine(SYSCFG_PORT_T port, SYSCFG_PIN_T pin)
{
    ...
    if (pin <= 0x03)
    {
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG1 &= ~mask;
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG1 |= status;
    }
    else if ((0x04 <= pin) & (pin <= 0x07))
    {
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG2 &= ~mask;
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG2 |= status;
    }
    else if ((0x08 <= pin) & (pin <= 0x0B))
    {
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG3 &= ~mask;
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG3 |= status;
    }
    else if ((0x0C <= pin) & (pin <= 0x0F))
    {
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG4 &= ~mask;
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->EINTCFG4 |= status;
    }
}
...
void SYSCFG_BreakLock(uint32_t lock)
{
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2_B.LOCK = 0;
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2_B.SRAMLOCK = 0;

    if (lock == SYSCFG_LOCK_LOCKUP)
    {
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2_B.LOCK = BIT_SET;
    }
    if (lock == SYSCFG_LOCK_SRAM)
    {
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2_B.SRAMLOCK = BIT_SET;
    }
}
...
uint8_t SYSCFG_ReadStatusFlag(uint32_t flag)
{
    ...
    status = (uint32_t)(((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2 & flag);
...
void SYSCFG_ClearStatusFlag(uint8_t flag)
{
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2 |= (uint32_t) flag;
}
