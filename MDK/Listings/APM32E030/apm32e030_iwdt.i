# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_iwdt.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_iwdt.h"
...
# 36 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_iwdt.h"
...
# 27 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_iwdt.c"
...
void IWDT_Enable(void)
{
    ((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->KEY = IWDT_KEY_ENABLE;
}
...
void IWDT_EnableWriteAccess(void)
{
    ((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->KEY = IWDT_KEY_ACCESS;
}
...
void IWDT_DisableWriteAccess(void)
{
    ((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->KEY = 0;
}
...
void IWDT_Refresh(void)
{
    ((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->KEY = IWDT_KEY_REFRESH;
}
...
void IWDT_ConfigDivider(IWDT_DIV_T div)
{
    ((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->PSC = (uint32_t)div;
}
...
void IWDT_ConfigReload(uint16_t reload)
{
    ((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->CNTRLD = (uint32_t)reload;
}
...
void IWDT_ConfigWindowValue(uint16_t windowValue)
{
    ((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->WIN = (uint32_t)windowValue;
}
...
uint8_t IWDT_ReadStatusFlag(uint8_t flag)
{
    ...
    if ((((IWDT_T*) (((uint32_t)0x40000000) + 0x00003000))->STS & flag) != (uint32_t)RESET)
    {
        bitStatus = SET;
    }
    else
