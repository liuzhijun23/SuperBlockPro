# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_dma.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_dma.h"
...
# 36 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_dma.h"
...
typedef enum
{
    DMA1_FLAG_AL1    = ((uint32_t)0x00000001),   
    DMA1_FLAG_TF1    = ((uint32_t)0X00000002),   
    DMA1_FLAG_HT1    = ((uint32_t)0X00000004),   
    DMA1_FLAG_TE1    = ((uint32_t)0X00000008),   

    DMA1_FLAG_AL2    = ((uint32_t)0x00000010),   
    DMA1_FLAG_TF2    = ((uint32_t)0x00000020),   
    DMA1_FLAG_HT2    = ((uint32_t)0x00000040),   
    DMA1_FLAG_TE2    = ((uint32_t)0x00000080),   

    DMA1_FLAG_AL3    = ((uint32_t)0x00000100),   
    DMA1_FLAG_TF3    = ((uint32_t)0x00000200),   
    DMA1_FLAG_HT3    = ((uint32_t)0x00000400),   
    DMA1_FLAG_TE3    = ((uint32_t)0x00000800),   

    DMA1_FLAG_AL4    = ((uint32_t)0x00001000),   
    DMA1_FLAG_TF4    = ((uint32_t)0x00002000),   
    DMA1_FLAG_HT4    = ((uint32_t)0x00004000),   
    DMA1_FLAG_TE4    = ((uint32_t)0x00008000),   

    DMA1_FLAG_AL5    = ((uint32_t)0x00010000),   
    DMA1_FLAG_TF5    = ((uint32_t)0x00020000),   
    DMA1_FLAG_HT5    = ((uint32_t)0x00040000),   
    DMA1_FLAG_TE5    = ((uint32_t)0x00080000),   
} DMA_FLAG_T;
...
typedef enum
{
    DMA1_INT_FLAG_AL1 = ((uint32_t)0x00000001),   
    DMA1_INT_FLAG_TF1 = ((uint32_t)0x00000002),   
    DMA1_INT_FLAG_HT1 = ((uint32_t)0x00000004),   
    DMA1_INT_FLAG_TE1 = ((uint32_t)0x00000008),   

    DMA1_INT_FLAG_AL2 = ((uint32_t)0x00000010),   
    DMA1_INT_FLAG_TF2 = ((uint32_t)0x00000020),   
    DMA1_INT_FLAG_HT2 = ((uint32_t)0x00000040),   
    DMA1_INT_FLAG_TE2 = ((uint32_t)0x00000080),   

    DMA1_INT_FLAG_AL3 = ((uint32_t)0x00000100),   
    DMA1_INT_FLAG_TF3 = ((uint32_t)0x00000200),   
    DMA1_INT_FLAG_HT3 = ((uint32_t)0x00000400),   
    DMA1_INT_FLAG_TE3 = ((uint32_t)0x00000800),   

    DMA1_INT_FLAG_AL4 = ((uint32_t)0x00001000),   
    DMA1_INT_FLAG_TF4 = ((uint32_t)0x00002000),   
    DMA1_INT_FLAG_HT4 = ((uint32_t)0x00004000),   
    DMA1_INT_FLAG_TE4 = ((uint32_t)0x00008000),   

    DMA1_INT_FLAG_AL5 = ((uint32_t)0x00010000),   
    DMA1_INT_FLAG_TF5 = ((uint32_t)0x00020000),   
    DMA1_INT_FLAG_HT5 = ((uint32_t)0x00040000),   
    DMA1_INT_FLAG_TE5 = ((uint32_t)0x00080000),   
} DMA_INT_FLAG_T;
...
typedef enum
{
    DMA_INT_TFIE    = 0x00000002,   
    DMA_INT_HTIE    = 0x00000004,   
    DMA_INT_TEIE    = 0x00000008,   
} DMA_INT_T;
...
typedef struct
{
    ...
    DMA_DIR_T                   direction;             
    uint32_t                    bufferSize;            
    DMA_MEMORY_DATASIZE_T       memoryDataSize;        
    DMA_PERIPHERAL_DATASIZE_T   peripheralDataSize;    
    DMA_MEMORY_INC_T            memoryInc;             
    DMA_PERIPHERAL_INC_T        peripheralInc;         
    DMA_CIRCULAR_T              circular;              
    DMA_PRIORITY_LEVEL_T        priority;              
    DMA_M2M_T                   memoryTomemory;        
} DMA_Config_T;
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_dma.c"
...
void DMA_Reset(DMA_CHANNEL_T* channel)
{
    ...
    if (channel == ((DMA_CHANNEL_T*) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008)))
    {
        ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR = (uint32_t)0x0000000F;
    }
    else if (channel == ((DMA_CHANNEL_T*) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x0000001C)))
    {
        ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR = (uint32_t)0x000000F0;
    }
    else if (channel == ((DMA_CHANNEL_T*) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000030)))
    {
        ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR = (uint32_t)0x00000F00;
    }
    else if (channel == ((DMA_CHANNEL_T*) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000044)))
    {
        ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR = (uint32_t)0x0000F000;
    }
    else if (channel == ((DMA_CHANNEL_T*) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000058)))
    {
        ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR = (uint32_t)0x000F0000;
    }
}
...
uint8_t DMA_ReadStatusFlag(DMA_FLAG_T flag)
{
    ...
    status = ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTSTS & ((uint32_t)flag & 0x0FFFFFFF);
...
void DMA_ClearStatusFlag(uint32_t flag)
{
    ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR |= (uint32_t)(flag & 0x0FFFFFFF);
}
