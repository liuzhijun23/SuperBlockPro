...
void SM16208_Init(void)
{
    ...
    g.pupd = GPIO_PUPD_NO;
    GPIO_Config(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), &g);
    ...
    g.pin = GPIO_PIN_0 ;
    GPIO_Config(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), &g);
    ...
    GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_3,1);
...
{
    u8 data = 0;
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_8))
        data |= 0x01;
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_9))
        data |= 0x02;
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_10))
        data |= 0x04;   
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_11))
        data |= 0x08; 
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_12))
        data |= 0x10;
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_6))
        data |= 0x20;
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_7))
        data |= 0x40;
    if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_15))
        data |= 0x80;
    return data;
}
...
void display_matrix(u8* matrix)
{
    for (uint8_t row = 0; row < 8; row++) 
    {
        ...
        for (int i = 0; i < 16; i++) 
        {
            if(send_data & 0x8000)
            {
                GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_7,Bit_SET);
            }
            else
            {
                GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_7,BIT_RESET);
            }

            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_5,Bit_SET);
            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_5,BIT_RESET);
            send_data <<= 1;
        }
        
        
        GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_4,BIT_SET);
        GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_4,BIT_RESET);
        
        
        GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_0,BIT_SET);
        
        
        if(row&0x04)
            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_0,BIT_SET);
        else
            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_0,BIT_RESET);

        if(row&0x02)
            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_1,BIT_SET);
        else
            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_1,BIT_RESET);

        if(row&0x01)
            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_1,BIT_SET);
        else
            GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_1,BIT_RESET);
        
        
        GPIO_WriteBitValue(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_0,BIT_RESET);
