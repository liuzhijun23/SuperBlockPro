...
# 7 "..\\Src\\GlobalVar.h"
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_gpio.h"
...
# 37 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_gpio.h"
...
extern u16 workTimeSetting;
extern u16 workTime;    
extern volatile u8 fall_flag;
extern volatile u16 fall_delay;
extern volatile u16 release_delay;
extern volatile u8 keyState;
extern volatile u8 work_event;
...
void Audio_Start(void)
{
    ...
    TMR_EnablePWMOutputs(((TMR_T*) (((uint32_t)0x40000000) + 0x00014000)));
    TMR_Enable(((TMR_T*) (((uint32_t)0x40000000) + 0x00014800)));
}
...
void Audio_Sop(void)
{
    ...
    TMR_DisablePWMOutputs(((TMR_T*) (((uint32_t)0x40000000) + 0x00014000)));
    TMR_Disable(((TMR_T*) (((uint32_t)0x40000000) + 0x00014800)));
