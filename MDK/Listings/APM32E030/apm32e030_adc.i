# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_adc.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_adc.h"
...
# 36 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_adc.h"
...
typedef enum
{
    ADC_CONVERSION_SINGLE        = ((uint8_t)0),   
    ADC_CONVERSION_CONTINUOUS    = ((uint8_t)1),   
} ADC_CONVERSION_T;
...
typedef enum
{
    ADC_JITTER_PCLKDIV2   = ((uint8_t)0x01),          
    ADC_JITTER_PCLKDIV4   = ((uint8_t)0x02),          
} ADC_JITTER_T;
...
typedef enum
{
    ADC_CLOCK_MODE_ASYNCLK      = ((uint8_t)0x00),    
    ADC_CLOCK_MODE_SYNCLKDIV2   = ((uint8_t)0x01),    
    ADC_CLOCK_MODE_SYNCLKDIV4   = ((uint8_t)0x02),    
} ADC_CLOCK_MODE_T;
...
typedef enum
{
    ADC_RESOLUTION_12B   = ((uint8_t)0x00),      
    ADC_RESOLUTION_10B   = ((uint8_t)0x01),      
    ADC_RESOLUTION_8B    = ((uint8_t)0x02),      
    ADC_RESOLUTION_6B    = ((uint8_t)0x03),      
} ADC_RESOLUTION_T;
...
typedef enum
{
    ADC_DATA_ALIGN_RIGHT    = ((uint8_t)0),  
    ADC_DATA_ALIGN_LEFT     = ((uint8_t)1),  
} ADC_DATA_ALIGN_T;
...
typedef enum
{
    ADC_SCAN_DIR_UPWARD     = ((uint8_t)0),      
    ADC_SCAN_DIR_BACKWARD   = ((uint8_t)1),      
} ADC_SCAN_DIR_T;
...
typedef enum
{
    ADC_DMA_MODE_ONESHOUT   = ((uint8_t)0),      
    ADC_DMA_MODE_CIRCULAR   = ((uint8_t)1),      
} ADC_DMA_MODE_T;
...
typedef enum
{
    ADC_EXT_TRIG_EDGE_NONE     = ((uint8_t)0x00),    
    ADC_EXT_TRIG_EDGE_RISING   = ((uint8_t)0x01),    
    ADC_EXT_TRIG_EDGE_FALLING  = ((uint8_t)0x02),    
    ADC_EXT_TRIG_EDGE_ALL      = ((uint8_t)0x03),    
} ADC_EXT_TRIG_EDGE_T;
...
typedef enum
{
    ADC_EXT_TRIG_CONV_TRG0   = ((uint8_t)0x00),      
    ADC_EXT_TRIG_CONV_TRG1   = ((uint8_t)0x01),      
    ADC_EXT_TRIG_CONV_TRG2   = ((uint8_t)0x02),      
    ADC_EXT_TRIG_CONV_TRG3   = ((uint8_t)0x03),      
    ADC_EXT_TRIG_CONV_TRG4   = ((uint8_t)0x04),      
} ADC_EXT_TRIG_CONV_T;
...
typedef enum
{
    ADC_ANALG_WDT_CHANNEL_0    = ((uint8_t)0x00),    
    ADC_ANALG_WDT_CHANNEL_1    = ((uint8_t)0x01),    
    ADC_ANALG_WDT_CHANNEL_2    = ((uint8_t)0x02),    
    ADC_ANALG_WDT_CHANNEL_3    = ((uint8_t)0x03),    
    ADC_ANALG_WDT_CHANNEL_4    = ((uint8_t)0x04),    
    ADC_ANALG_WDT_CHANNEL_5    = ((uint8_t)0x05),    
    ADC_ANALG_WDT_CHANNEL_6    = ((uint8_t)0x06),    
    ADC_ANALG_WDT_CHANNEL_7    = ((uint8_t)0x07),    
    ADC_ANALG_WDT_CHANNEL_8    = ((uint8_t)0x08),    
    ADC_ANALG_WDT_CHANNEL_9    = ((uint8_t)0x09),    
    ADC_ANALG_WDT_CHANNEL_10   = ((uint8_t)0x0A),    
    ADC_ANALG_WDT_CHANNEL_11   = ((uint8_t)0x0B),    
    ADC_ANALG_WDT_CHANNEL_12   = ((uint8_t)0x0C),    
    ADC_ANALG_WDT_CHANNEL_13   = ((uint8_t)0x0D),    
    ADC_ANALG_WDT_CHANNEL_14   = ((uint8_t)0x0E),    
    ADC_ANALG_WDT_CHANNEL_15   = ((uint8_t)0x0F),    
    ADC_ANALG_WDT_CHANNEL_16   = ((uint8_t)0x10),    
    ADC_ANALG_WDT_CHANNEL_17   = ((uint8_t)0x11),    
    ADC_ANALG_WDT_CHANNEL_18   = ((uint8_t)0x12),    
...
typedef enum
{
    ADC_CHANNEL_0    = ((uint32_t)0x00000001),   
    ADC_CHANNEL_1    = ((uint32_t)0x00000002),   
    ADC_CHANNEL_2    = ((uint32_t)0x00000004),   
    ADC_CHANNEL_3    = ((uint32_t)0x00000008),   
    ADC_CHANNEL_4    = ((uint32_t)0x00000010),   
    ADC_CHANNEL_5    = ((uint32_t)0x00000020),   
    ADC_CHANNEL_6    = ((uint32_t)0x00000040),   
    ADC_CHANNEL_7    = ((uint32_t)0x00000080),   
    ADC_CHANNEL_8    = ((uint32_t)0x00000100),   
    ADC_CHANNEL_9    = ((uint32_t)0x00000200),   
    ADC_CHANNEL_10   = ((uint32_t)0x00000400),   
    ADC_CHANNEL_11   = ((uint32_t)0x00000800),   
    ADC_CHANNEL_12   = ((uint32_t)0x00001000),   
    ADC_CHANNEL_13   = ((uint32_t)0x00002000),   
    ADC_CHANNEL_14   = ((uint32_t)0x00004000),   
    ADC_CHANNEL_15   = ((uint32_t)0x00008000),   
    ADC_CHANNEL_16   = ((uint32_t)0x00010000),   
    ADC_CHANNEL_17   = ((uint32_t)0x00020000),   
    ADC_CHANNEL_18   = ((uint32_t)0x00040000),   
} ADC_CHANNEL_T;
...
typedef enum
{
    ADC_INT_ADRDY    = ((uint8_t)0x01),  
    ADC_INT_CSMP     = ((uint8_t)0x02),  
    ADC_INT_CC       = ((uint8_t)0x04),  
    ADC_INT_CS       = ((uint8_t)0x08),  
    ADC_INT_OVR      = ((uint8_t)0x10),  
    ADC_INT_AWD      = ((uint8_t)0x80),  
} ADC_INT_T;
...
typedef enum
{
    ADC_INT_FLAG_ADRDY    = ((uint8_t)0x01),     
    ADC_INT_FLAG_CSMP     = ((uint8_t)0x02),     
    ADC_INT_FLAG_CC       = ((uint8_t)0x04),     
    ADC_INT_FLAG_CS       = ((uint8_t)0x08),     
    ADC_INT_FLAG_OVR      = ((uint8_t)0x10),     
    ADC_INT_FLAG_AWD      = ((uint8_t)0x80),     
} ADC_INT_FLAG_T;
...
typedef enum
{
    ADC_FLAG_ADCON   = ((uint32_t)0x01000001),   
    ADC_FLAG_ADCOFF  = ((uint32_t)0x01000002),   
    ADC_FLAG_ADCSTA  = ((uint32_t)0x01000004),   
    ADC_FLAG_ADCSTOP = ((uint32_t)0x01000010),   
    ADC_FLAG_ADCCAL  = ((int)     0x81000000),   
    ADC_FLAG_ADRDY   = ((uint8_t)0x01),          
    ADC_FLAG_CSMP    = ((uint8_t)0x02),          
    ADC_FLAG_CC      = ((uint8_t)0x04),          
    ADC_FLAG_CS      = ((uint8_t)0x08),          
    ADC_FLAG_OVR     = ((uint8_t)0x10),          
    ADC_FLAG_AWD     = ((uint8_t)0x80),          
} ADC_FLAG_T;
...
typedef struct
{
    ...
    ADC_SCAN_DIR_T      scanDir;         
    ADC_CONVERSION_T    convMode;        
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_adc.c"
...
# 29 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_adc.c"
...
void ADC_Config(ADC_Config_T* adcConfig)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.DATARESCFG = adcConfig->resolution;
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.DALIGCFG   = adcConfig->dataAlign;
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.SCANSEQDIR = adcConfig->scanDir;
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.CMODESEL   = adcConfig->convMode;
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.EXTPOLSEL  = adcConfig->extTrigEdge;
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.EXTTRGSEL  = adcConfig->extTrigConv;
}
...
void ADC_Enable(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL_B.ADCEN = BIT_SET;
}
...
void ADC_Disable(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL_B.ADCD = BIT_SET;
}
...
void ADC_ClockMode(ADC_CLOCK_MODE_T clockMode)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG2_B.CLKCFG = (uint32_t)clockMode;
}
...
void ADC_EnableJitter(ADC_JITTER_T jitter)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG2_B.CLKCFG |= (uint32_t)jitter;
}
...
void ADC_EnableAutoPowerOff(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.AOEN = BIT_SET;
}
...
void ADC_DisableAutoPowerOff(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.AOEN = BIT_RESET;
}
...
void ADC_EnableWaitMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.WAITCEN = BIT_SET;
}
...
void ADC_DisableWaitMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.WAITCEN = BIT_RESET;
}
...
void ADC_EnableAnalogWatchdog(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.AWDEN = BIT_SET;
}
...
void ADC_DisableAnalogWatchdog(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.AWDEN = BIT_RESET;
}
...
void ADC_AnalogWatchdogLowThreshold(uint16_t lowThreshold)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->AWDT_B.AWDLT = (uint16_t)lowThreshold;
}
...
void ADC_AnalogWatchdogHighThreshold(uint16_t highThreshold)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->AWDT_B.AWDHT = (uint16_t)highThreshold;
}
...
void ADC_AnalogWatchdogSingleChannel(uint32_t channel)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.AWDCHSEL = channel;
}
...
void ADC_EnableAnalogWatchdogSingleChannel(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.AWDCHEN = BIT_SET;
}
...
void ADC_DisableAnalogWatchdogSingleChannel(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.AWDCHEN = BIT_RESET;
}
...
void ADC_EnableTempSensor(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CCFG_B.TSEN = BIT_SET;
}
...
void ADC_DisableTempSensor(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CCFG_B.TSEN = BIT_RESET;
}
...
void ADC_EnableVrefint(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CCFG_B.VREFEN = BIT_SET;
}
...
void ADC_DisableVrefint(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CCFG_B.VREFEN = BIT_RESET;
}
...
void ADC_ConfigChannel(uint32_t channel, uint8_t sampleTime)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CHSEL |= (uint32_t)channel;

    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->SMPTIM |= (uint8_t)sampleTime;
}
...
void ADC_EnableContinuousMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.CMODESEL = BIT_SET;
}
...
void ADC_DisableContinuousMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.CMODESEL = BIT_RESET;
}
...
void ADC_EnableDiscMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.DISCEN = BIT_SET;
}
...
void ADC_DisableDiscMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.DISCEN = BIT_RESET;
}
...
void ADC_EnableOverrunMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.OVRMAG = BIT_SET;
}
...
void ADC_DisableOverrunMode(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.OVRMAG = BIT_RESET;
}
...
uint32_t ADC_ReadCalibrationFactor(void)
{
    ...
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL_B.CAL = BIT_SET;

    do
    {
        status =  ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL_B.CAL;
        counter++;
    }
    while ((counter != ((uint32_t)0x0000F000)) && (status != 0x00));

    if ((uint32_t)(((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL_B.CAL) == RESET)
    {
        temp = ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->DATA;
    }
    else
    {
        temp = 0x00000000;
...
void ADC_StopConversion(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL_B.STOPCEN = BIT_SET;
}
...
void ADC_StartConversion(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL_B.STARTCEN = BIT_SET;
}
...
uint16_t ADC_ReadConversionValue(void)
{
    return ((uint16_t)((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->DATA);
}
...
void ADC_EnableDMA(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.DMAEN = BIT_SET;
}
...
void ADC_DisableDMA(void)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.DMAEN = BIT_RESET;
}
...
void ADC_DMARequestMode(ADC_DMA_MODE_T DMARequestMode)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CFG1_B.DMACFG = (uint8_t)DMARequestMode;
}
...
void ADC_EnableInterrupt(uint8_t interrupt)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->INT |= (uint32_t)interrupt;
}
...
uint8_t ADC_ReadStatusFlag(ADC_FLAG_T flag)
{
    ...
    {
        status = ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->CTRL & 0xFEFFFFFF;
    }
    else
    {
        status = ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->STS;
    }
...
void ADC_ClearStatusFlag(uint32_t flag)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->STS = (uint32_t)flag;
}
...
uint8_t ADC_ReadIntFlag(ADC_INT_FLAG_T flag)
{
    ...
    intEnable = (uint8_t)(((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->INT& (uint32_t)flag);

    intStatus = (uint8_t)(((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->STS & (uint32_t)(flag & 0xff));
...
void ADC_ClearIntFlag(uint32_t flag)
{
    ((ADC_T*) (((uint32_t)0x40000000) + 0x00012400))->STS = flag;
}
