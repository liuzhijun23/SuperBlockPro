# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_i2c.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_i2c.h"
...
# 36 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_i2c.h"
...
# 68 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_i2c.h"
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_i2c.c"
...
# 29 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_i2c.c"
...
void I2C_Reset(I2C_T* i2c)
{
    if (i2c == ((I2C_T*) (((uint32_t)0x40000000) + 0x00005400)))
    {
...
void I2C_Config(I2C_T* i2c, I2C_Config_T* i2cConfig)
{
    ...
    temp = (uint32_t)((uint32_t)i2cConfig->ackaddress << 10 |                       (uint32_t)i2cConfig->address1);
...
{
    i2c->CTRL1_B.I2CEN = BIT_RESET;
    *(volatile uint32_t*)(uint32_t)i2c;
    i2c->CTRL1_B.I2CEN = BIT_SET;
}
...
void I2C_HandlingTransfer(I2C_T* i2c, uint16_t address, uint8_t number, I2C_RELOAD_MODE_T reloadend, I2C_GENERATE_T generates)
{
    ...
    temp &= (uint32_t)~((uint32_t)(((uint32_t)0x000003FF) | ((uint32_t)0x00FF0000) | ((uint32_t)0x03006400)));

     
    temp |= (uint32_t)(((uint32_t)address & ((uint32_t)0x000003FF)) | (((uint32_t)number << 16) & ((uint32_t)0x00FF0000)) |                        (uint32_t)reloadend | (uint32_t)generates);
...
uint8_t I2C_ReadIntFlag(I2C_T* i2c, I2C_INT_FLAG_T flag)
{
    ...
    {
        enable = (uint32_t)((0x00000040) & (i2c->CTRL1));
    }
    else if (flag & ((uint32_t)0x00003F00))
    {
        enable = (uint32_t)((0x00000080) & (i2c->CTRL1));
    }
    else
    {
