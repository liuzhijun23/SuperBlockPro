# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_crc.c"
...
# 1 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_crc.h"
...
# 36 "..\\Driver\\APM32E030_StdPeriphDriver\\inc\\apm32e030_crc.h"
...
# 28 "..\\Driver\\APM32E030_StdPeriphDriver\\src\\apm32e030_crc.c"
...
void CRC_Reset(void)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->DATA = 0xFFFFFFFF;
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->INDATA = 0x00;
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->INITVAL = 0xFFFFFFFF;
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->CTRL = 0x00000000;
}
...
void CRC_ResetDATA(void)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->CTRL_B.RST = BIT_SET;
}
...
void CRC_SelectReverseInputData(CRC_REVERSE_INPUT_DATA_T revInData)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->CTRL_B.REVI = revInData;
}
...
void CRC_EnableReverseOutputData(void)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->CTRL_B.REVO = BIT_SET;
}
...
void CRC_DisableReverseOutputData(void)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->CTRL_B.REVO = BIT_RESET;
}
...
void CRC_WriteInitRegister(uint32_t initValue)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->INITVAL = initValue;
}
...
uint32_t CRC_CalculateCRC(uint32_t data)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->DATA = data;

    return (((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->DATA);
}
...
uint32_t CRC_CalculateBlockCRC(uint32_t pBuffer[], uint32_t bufferLength)
{
    ...
    {
        ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->DATA = pBuffer[index];
    }
...
void CRC_WriteIDRegister(uint8_t IDValue)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->INDATA = IDValue;
}
...
uint8_t CRC_ReadIDRegister(void)
{
    return (((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->INDATA);
}
