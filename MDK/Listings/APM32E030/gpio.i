...
void SpeakerInit(void)
{
    ...
    GPIO_ConfigPinAF(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), GPIO_PIN_SOURCE_2, GPIO_AF_PIN0);
    GPIO_ConfigPinAF(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), GPIO_PIN_SOURCE_3, GPIO_AF_PIN0);
    gpioconfig.mode  = GPIO_MODE_AF;
    gpioconfig.outtype = GPIO_OUT_TYPE_PP;
    gpioconfig.pin   = GPIO_PIN_2|GPIO_PIN_3;
    gpioconfig.pupd  = GPIO_PUPD_NO;
    gpioconfig.speed = GPIO_SPEED_50MHz;
    GPIO_Config(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), &gpioconfig);
    ...
    timeBaseConfig.period = 255;
     
    timeBaseConfig.repetitionCounter =  0;
    TMR_ConfigTimeBase(((TMR_T*) (((uint32_t)0x40000000) + 0x00012C00)), &timeBaseConfig);
    ...
    occonfig.Pulse = 128;
    TMR_OC1Config(((TMR_T*) (((uint32_t)0x40000000) + 0x00014000)), &occonfig);

    occonfig.OC_Polarity  = TMR_OC_POLARITY_LOW;
    TMR_OC2Config(((TMR_T*) (((uint32_t)0x40000000) + 0x00014000)), &occonfig);

     
    TMR_EnablePWMOutputs(((TMR_T*) (((uint32_t)0x40000000) + 0x00014000)));
     
    TMR_Enable(((TMR_T*) (((uint32_t)0x40000000) + 0x00014000)));
}

void Set_Speaker_Duty(uint16_t duty_ch1, uint16_t duty_ch2)
{
    if (duty_ch1 > 255) duty_ch1 = 255;
    if (duty_ch2 > 255) duty_ch2 = 255;

    ((TMR_T*) (((uint32_t)0x40000000) + 0x00014000))->CC1 = duty_ch1;
    ((TMR_T*) (((uint32_t)0x40000000) + 0x00014000))->CC2 = duty_ch2;
}
