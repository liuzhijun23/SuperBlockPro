...
void TIM6_Config(void)
{
    ...
    TMR_ConfigTimeBase(((TMR_T*) (((uint32_t)0x40000000) + 0x00001000)), &timeBaseConfig);

     
    TMR_EnableInterrupt(((TMR_T*) (((uint32_t)0x40000000) + 0x00001000)), TMR_INT_UPDATE);
    NVIC_EnableIRQRequest(TMR6_IRQn, 2);

     
    TMR_Enable(((TMR_T*) (((uint32_t)0x40000000) + 0x00001000)));
}
...
void TIM17_Config(void)
{
    ...
    TMR_ConfigTimeBase(((TMR_T*) (((uint32_t)0x40000000) + 0x00014800)), &timeBaseConfig);

     
    TMR_EnableInterrupt(((TMR_T*) (((uint32_t)0x40000000) + 0x00014800)), TMR_INT_UPDATE);
