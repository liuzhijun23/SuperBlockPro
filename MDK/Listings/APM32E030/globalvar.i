...
u16 workTimeSetting = 60;
u16 workTime = 0;    
volatile u8 fall_flag = 0;
volatile u16 fall_delay = 0; 
volatile u16 release_delay = 0;
volatile u8 keyState = 0;
volatile u8 work_event = 0;
...
u16 ReadTimeSetting(void)
{
    ...
    u16 time = *(volatile u16 *)0x0800FC00;
    if (time == 0xFFFF)
    {
        time = 60;
    }
...
void WriteTimeSetting(u16 time)
{
    ...
    if (FMC_ErasePage(0x0800FC00) == FMC_STATE_COMPLETE)
    {
         
        FMC_ProgramHalfWord(0x0800FC00, time);
    }
